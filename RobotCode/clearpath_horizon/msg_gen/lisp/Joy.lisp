...
(cl:defmethod cl:initialize-instance :after ((m <Joy>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Joy)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name clearpath_horizon-msg:<Joy> is deprecated: use clearpath_horizon-msg:Joy instead.")))

(cl:ensure-generic-function 'axes-val :lambda-list '(m))
(cl:defmethod axes-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_horizon-msg:axes-val is deprecated.  Use clearpath_horizon-msg:axes instead.")
  (axes m))

(cl:ensure-generic-function 'buttons-val :lambda-list '(m))
(cl:defmethod buttons-val ((m <Joy>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader clearpath_horizon-msg:buttons-val is deprecated.  Use clearpath_horizon-msg:buttons instead.")
  (buttons m))
